...
\href{https://github.com/getsimpledirect/vinci-gpu-research/tree/7cdfb4b68b7265be7f6c7299b107ff9d924f2a2d/p-breve-01-r2}{\texttt{7cdfb4b68b7265be7f6c7299b107ff9d924f2a2d}};
...
\includegraphics{figures/figure1_study_lineage.png}
...
\hypertarget{21-adaptive-reasoning-and-early-stopping}{%
...
\hypertarget{22-direct-preference-optimization-and-length-control}{%
...
\hypertarget{23-executable-rewards-public-tests-and-reward-hacking}{%
...
\hypertarget{24-mutation-testing-as-evaluator-qualification}{%
...
\hypertarget{3-study-lineage-and-protocol}{%
\subsection{3. Study Lineage and
Protocol}\label{3-study-lineage-and-protocol}}

\hypertarget{31-p-breve-01-and-the-r2-recovery-study}{%
...
\hypertarget{32-evidence-tier-and-report-cutoff}{%
...
The final report must bind to one source commit and one evidence cutoff.
This draft intentionally leaves that field unresolved. Continued
evaluator engineering after the cutoff should be treated as successor
work rather than allowed to reopen the completed model-intervention
result indefinitely.

\hypertarget{33-model-and-serving-stack}{%
...
\hypertarget{35-data-construction-and-acceptance}{%
...
\hypertarget{36-original-evaluation-bank}{%
...
\hypertarget{37-bounded-dose-and-serving-control-screens}{%
...
\hypertarget{38-artifact-and-claim-governance}{%
...
now represented by claim \texttt{pbr2.g4.full-recipe-insufficient.015}.
...
\includegraphics{figures/figure2_one_epoch_reduction.png}

\hypertarget{4-results}{%
\subsection{4. Results}\label{4-results}}

\hypertarget{41-the-intervention-executed-but-execution-was-not-the-scientific-endpoint}{%
...
\hypertarget{42-the-configured-one-epoch-sft-to-dpo-recipe-missed-every-positive-efficiency-target}{%
...
\hypertarget{43-a-stronger-dpo-dose-produced-an-apparent-code-stratum-response-under-xhigh}{%
...
\hypertarget{44-a-serving-control-reproduced-the-termination-improvement-on-untrained-weights}{%
...
\includegraphics{figures/figure3_serving_effort_control.png}

\hypertarget{45-the-original-executable-code-evaluator-accepted-every-broad-shortcut-attack}{%
...
\hypertarget{46-a-runtimecertification-split-improved-broad-shortcut-rejection-but-remained-unqualified}{%
...
(17.5\%)} \\
\texttt{P(certification\ pass\ given\ runtime\ pass)} on the designed
probe population & --- & \textbf{64/296 = 0.216}, 95\% CI {[}0.171,
0.268{]} \\
\end{longtable}
...
\hypertarget{47-independent-mutation-populations-showed-that-targeted-repairs-did-not-generalize}{%
...
\includegraphics{figures/figure5_task_count_disambiguation.png}
...
\texttt{p-breve-01-r2/docs/BLIND-ADVERSARIAL-POPULATION.md}, section
``The protected bank leaks worse than staging.'' Version 1.0 verified
the source at working commit
...
stored observation. The final publication manifest must rebind the
source cells and derivation to the merged evidence-cutoff commit.
...
\includegraphics{figures/figure4_evaluator_qualification.png}

\hypertarget{48-the-study-repeatedly-measured-the-wrong-estimand-before-correcting-it}{%
...
\hypertarget{481-cap-exhaustion-was-excluded-from-the-denominator}{%
...
\hypertarget{482-medians-were-censored-on-the-stratum-that-mattered}{%
...
\hypertarget{483-nominal-task-identifiers-were-not-independent-experimental-units}{%
...
\hypertarget{484-the-analytical-power-calculation-did-not-represent-the-frozen-decision-procedure}{%
...
\hypertarget{49-reproducible-artifacts-selected-the-wrong-authority-and-exposed-hidden-information}{%
...
\hypertarget{410-final-claim-disposition}{%
...
(\texttt{pbr2.g4.full-recipe-insufficient.015})} & The token and
...
\hypertarget{51-the-cheapest-adequate-control-should-precede-weight-updates}{%
...
\hypertarget{52-runtime-success-is-a-workflow-signal-not-a-correctness-certificate}{%
...
\hypertarget{53-coverage-should-be-measured-by-killed-alternatives-not-category-labels}{%
...
\hypertarget{54-evaluator-qualification-is-part-of-the-experiment-not-post-hoc-hygiene}{%
...
\hypertarget{55-a-negative-intervention-result-can-still-advance-the-research-program}{%
...
\hypertarget{56-the-durable-research-direction-is-verified-adaptive-reasoning}{%
...
\hypertarget{6-limitations}{%
\subsection{6. Limitations}\label{6-limitations}}

\hypertarget{61-development-evidence-not-confirmation}{%
...
\hypertarget{62-one-model-lineage-and-one-narrow-intervention-family}{%
...
\hypertarget{63-the-original-correctness-evaluator-was-invalid}{%
...
\hypertarget{64-the-serving-control-screen-was-small-and-clustered}{%
...
\hypertarget{65-the-banks-were-enriched-and-cannot-estimate-product-prevalence}{%
...
\hypertarget{66-safety-and-broad-capability-were-not-measured-adequately}{%
...
\hypertarget{67-cap-exhaustion-does-not-identify-the-internal-mechanism}{%
...
\hypertarget{68-mutation-populations-were-incomplete-by-construction}{%
...
\hypertarget{69-some-calibration-outputs-could-not-be-reconstructed-fully}{%
...
\hypertarget{610-agent-assisted-research-is-not-independent-validation}{%
...
\hypertarget{7-recommendations-and-successor-work}{%
\subsection{7. Recommendations and Successor
Work}\label{7-recommendations-and-successor-work}}

\hypertarget{71-close-the-model-intervention-and-separate-evaluator-work}{%
...
\hypertarget{72-freeze-a-report-cutoff-rather-than-waiting-for-a-perfect-evaluator}{%
...
\hypertarget{73-adopt-vinci-eval-integrity-01-before-model-outcomes}{%
...
\hypertarget{74-make-mutation-qualification-bidirectional}{%
...
\hypertarget{75-compare-controllers-before-retraining}{%
...
\hypertarget{76-separate-mechanism-and-product-banks}{%
...
\hypertarget{77-add-cross-domain-promotion-gates}{%
...
\hypertarget{78-run-p-breve-02-only-after-the-instrument-and-comparator-are-fixed}{%
...
\hypertarget{79-publish-the-negative-and-corrective-artifacts}{%
...
\hypertarget{8-reproducibility-and-evidence-availability}{%
\subsection{8. Reproducibility and Evidence
Availability}\label{8-reproducibility-and-evidence-availability}}

\hypertarget{81-source-identity}{%
\subsubsection{8.1 Source identity}\label{81-source-identity}}

The publication package must replace the placeholder below with a full
commit SHA after the manuscript, evidence manifest, and claim table are
frozen.
...
\item
  ...
  \texttt{getsimpledirect/vinci-technical-reports}
\item
  Publication source commit: \textbf{{[}TO BE FROZEN{]}}
\item
  Report evidence cutoff: \textbf{{[}TO BE RULED{]}}
\item
  PDF and source digests: \textbf{{[}TO BE GENERATED AFTER CONTENT
  APPROVAL{]}}
\end{itemize}

\hypertarget{82-recomputable-analyses}{%
\subsubsection{8.2 Recomputable
analyses}\label{82-recomputable-analyses}}

The core evaluator analyses are represented by committed scripts and
content-addressed outputs. The final release manifest should bind at
least the following:
...
similarly recorded the exact frozen authority hashes on every run.
Publication scripts should refuse to render if a cited evidence digest
is missing or if a table value differs from its machine-readable source.

\hypertarget{83-protected-and-unavailable-materials}{%
...
\hypertarget{84-recommended-publication-manifest}{%
\subsubsection{8.4 Recommended publication
manifest}\label{84-recommended-publication-manifest}}

The final report package should contain one machine-readable manifest
with:
...
recommended for release. The report itself is the release candidate.
...
\hypertarget{competing-interests-funding-and-ai-assistance}{%
...
The study used company-controlled compute. \textbf{{[}FUNDING DISCLOSURE
REQUIRED: state whether any GPU costs were reimbursed or expected to be
reimbursed under the Government of Canada AI Compute Access Fund or
another program; include award or agreement identifiers and the funder's
role, if any. State explicitly that the funder had no role in study
design, analysis, interpretation, or publication decision unless that is
not true.{]}}
...
consistency review, and manuscript drafting. Other model providers
should be added if their systems made material contributions.
AI-generated outputs were treated as proposals or evidence-processing
assistance, not as scholarly authorship or independent validation. The
human author remains responsible for protocol decisions, factual
verification, corrections, interpretation, and publication claims.

\hypertarget{ethics-and-safety-statement}{%
...
\hypertarget{appendix-a-claim-to-evidence-boundary}{%
\subsection{Appendix A. Claim-to-Evidence
Boundary}\label{appendix-a-claim-to-evidence-boundary}}

\includegraphics{figures/figure6_vinci_eval_integrity.png}

This appendix is intended to become machine-checked before publication.
The ``public sentence'' column is deliberately narrower than the
underlying internal record.

\hypertarget{a1-derived-quantity-register}{%
...
The final manifest should encode the following derivations directly.
...
\hypertarget{a2-public-claim-boundary}{%
...
\hypertarget{appendix-b-correction-and-withdrawal-timeline}{%
...
The final version should replace approximate day-level entries with
exact commits and artifact hashes generated mechanically from the
repository history.

\hypertarget{appendix-c-vinci-eval-integrity-01--seven-check-admission-record}{%
...
\hypertarget{appendix-d-proposed-figures-and-tables}{%
\subsection{Appendix D. Proposed Figures and
Tables}\label{appendix-d-proposed-figures-and-tables}}

The content draft intentionally uses placeholders instead of generating
visuals before the claim surface is approved.

\hypertarget{figure-1--study-lineage-and-claim-disposition}{%
...
\hypertarget{figure-2--experimental-and-audit-design}{%
...
\hypertarget{figure-3--serving-control-on-executable-code}{%
...
\hypertarget{figure-4--verifier-qualification-funnel}{%
...
\item
  ...
  \texttt{p-breve-01-r2/docs/BLIND-ADVERSARIAL-POPULATION.md};
\item
...
\hypertarget{figure-5--final-claim-boundary}{%
...
\hypertarget{appendix-e-pre-publication-gate}{%
\subsection{Appendix E. Pre-Publication
Gate}\label{appendix-e-pre-publication-gate}}

The report should not receive a DOI until every item below is closed.

\begin{itemize}
\tightlist
\item[$\square$]
  Report number and title ruled.
\item[$\square$]
  Program closure and evidence cutoff ruled.
\item[$\square$]
  Exact source commit frozen.
\item[$\square$]
  Sole author recorded consistently as George Pu in front matter, title
  block, contribution statement, DOI metadata, and artifact manifest.
\item[$\square$]
  Sole-author CRediT statement approved by George Pu after the final
  source exists.
\item[$\square$]
  Funding and compute-reimbursement disclosures complete.
\item[$\square$]
  Every numerical table generated from machine-readable evidence.
\item[$\square$]
  Every signed metric rendered from a canonical definition containing
  formula, comparator, unit, positive direction, and zero
  interpretation.
\item[$\square$]
  The one-epoch −10.9\% and two-epoch +10.9\% seed-1729 values are
  arm-labeled everywhere, including the abstract and DOI metadata.
\item[$\square$]
  Claim \texttt{pbr2.g4.full-recipe-insufficient.015} is present in the
  frozen claims-registry snapshot and bound to the final decision
  packet.
\item[$\square$]
  The 154/322, 7/157, and 52/1,862 renderings each bind the exact
  numerator field, denominator field, derivation formula, source path,
  commit, and blob hash.
\item[$\square$]
  Every \texttt{21/40} occurrence is labeled as either AST-no-leak or
  cross-method known-flaw union; no unqualified \texttt{21/40} remains.
\item[$\square$]
  Every withdrawn or suspended number searched across the manuscript and
  appendices.
\item[$\square$]
  No correctness figure from the condemned bank appears without a
  historical warning.
\item[$\square$]
  No 0/n observation described as a known zero population rate.
\item[$\square$]
  No nominal task count used without its family/cluster unit.
\item[$\square$]
  Reported confidence intervals reproduce from the frozen script and
  seed.
\item[$\square$]
  Protected cases and private infrastructure details removed.
\item[$\square$]
  Public artifact manifest lists every omitted component and why.
\item[$\square$]
  Independent statistical review completed by a person or group not
  responsible for the original analysis.
\item[$\square$]
  Independent verifier/code review completed against the production
  path.
\item[$\square$]
  Hostile claim audit asks what each sentence would imply to a reader
  who sees only the abstract.
\item[$\square$]
  Final Markdown, PDF, HTML, DOCX, figures, and manifest hashed.
\item[$\square$]
  George Pu approves the exact final source commit and artifact hashes
  after generation.
\item[$\square$]
  DOI metadata matches the final title, sole-author identity, date,
  version, abstract, and license.
\end{itemize}
